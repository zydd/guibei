...
def test_native_type_alias():
    ...
    assert isinstance(comp.root_context.types["i32"].super_, compiler.typedef.NativeType)
    assert comp.wasm == []
...
def test_native_type_alias_array():
    ...
    assert isinstance(comp.root_context.types["float_arr"], compiler.typedef.ArrayType)
...
def test_tuple_alias():
    ...
    assert isinstance(comp.root_context.types["float_pair"], compiler.typedef.TupleType)
...
def test_tuple_nested():
    ...
    assert isinstance(comp.root_context.types["float_mat"].field_types[0].type_, compiler.typedef.TupleType)
    assert isinstance(comp.root_context.types["float_mat"].field_types[1].type_, compiler.typedef.TupleType)
